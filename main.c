...
Name : Guruprasad M H
Date : 15 - 12 - 2025
Description : Program to encode a secret message into image file and decode that image file
Sample input for encoding : ./a.out -e beautiful.bmp secret.txt stego.bmp 
Sample input for decoding : ./a.out -d stego.bmp output.c
Sample output for encoding : stego.bmp image is created which contains encoded secret message
Sample output for decoding : output file is created which contains decoded message from stego.bmp image file
*/
